function graph_job_collector(param_file,graph_file, graph_error_file,...
                                segmentation_error_file, output_file) %#ok<*INUSL>
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    save(output_file,'param_file','graph_file','graph_error_file','segmentation_error_file');
