...
neuTokenTruth = params[2:4]
neuServerTruth = params[4:6]
synTokenTruth = params[6:8]
synServerTruth = params[8:10]
resolution = params[10:12]
xStart = params[12:14]
xStop = params[14:16]
yStart = params[16:18]
yStop = params[18:20]
zStart = params[20:22]
zStop = params[22:24]
useSemaphore = params[24:26]
attEdge = params[26:28]
segErr = params[28:30]
graphErr = params[30:32]
...
print neuTokenTruth
print type(neuTokenTruth)
print type([neuTokenTruth])
print type(''.join(neuTokenTruth))
print type(edgeServer)

args = [wrapper] + ["packages/graph_gen/graph_gen_driver.m"] + neuTokenTruth + neuServerTruth + synTokenTruth + synServerTruth + edgeToken + edgeServer + nodeToken + nodeServer + resolution + xStart + xStop + yStart + yStop + zStart + zStop + useSemaphore + attEdge + segErr + graphErr
