...
resolution = params[2:4]
useSemaphore = params[4:6]
attEdge = params[6:8]
edgeList = params[8:10]
...
args = [wrapper] + ["packages/graph_gen/build_graph.m"] + nodeToken + nodeServer + edgeToken + edgeServer + resolution + useSemaphore + attEdge + edgeList
